...
public enum HttpStatusEnum {
     ...
     * @deprecated in favor of {@link #FOUND} which will be returned from {@code HttpStatusEnum.valueOf(302)}
     */
    @Deprecated
     ...
     * returned from {@code HttpStatusEnum.valueOf(413)}
     */
    @Deprecated
     ...
     * @deprecated in favor of {@link #URI_TOO_LONG} which will be returned from {@code HttpStatusEnum.valueOf(414)}
     */
    @Deprecated
     ...
     * {@link top.isopen.commons.springboot.enums.HttpStatusEnum.Series#INFORMATIONAL}.
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link top.isopen.commons.springboot.enums.HttpStatusEnum.Series#SUCCESSFUL}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     * @since 4.0
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link top.isopen.commons.springboot.enums.HttpStatusEnum.Series#REDIRECTION}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     * @since 4.0
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link top.isopen.commons.springboot.enums.HttpStatusEnum.Series#CLIENT_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     * @since 4.0
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link top.isopen.commons.springboot.enums.HttpStatusEnum.Series#SERVER_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     * @since 4.0
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link top.isopen.commons.springboot.enums.HttpStatusEnum.Series#CLIENT_ERROR} or
     * {@link top.isopen.commons.springboot.enums.HttpStatusEnum.Series#SERVER_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
    ...
    /**
     * Return the {@code HttpStatusEnum} enum constant with the specified numeric value.
     *
    ...
    /**
     * Resolve the given status code to an {@code HttpStatusEnum}, if possible.
     *
     * @param statusCode the HTTP status code (potentially non-standard)
     * @return the corresponding {@code HttpStatusEnum}, or {@code null} if not found
     * @since 5.0
     */
    ...
    public enum Series {
        ...
        /**
         * Return the {@code Series} enum constant for the supplied {@code HttpStatusEnum}.
         *
        ...
        /**
         * Resolve the given status code to an {@code HttpStatusEnum.Series}, if possible.
         *
         * @param statusCode the HTTP status code (potentially non-standard)
